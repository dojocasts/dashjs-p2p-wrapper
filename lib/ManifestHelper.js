...
class ManifestHelper {
    ...
    constructor (player, manifestProvider, dashjsInternals) {
    ...
    getSegmentList (trackView, beginTime, duration) {
        ...
        if (isDynamic) {
            ...
            // };
            // var extendedLiveEdge = beginTime + duration;
            // if (representation.segmentAvailabilityRange.end < extendedLiveEdge) {
            //     console.info("extending segmentAvailabilityRange.end");
            //     representation.segmentAvailabilityRange.end = extendedLiveEdge;
            // }

            console.info(
                "getSegmentList()",
                representation.segmentAvailabilityRange.end - representation.segmentAvailabilityRange.start,
                representation.segmentAvailabilityRange
            );
            ...
            if (!isNaN(representation.segmentDuration) && representation.segmentDuration > 0) {
                ...
                console.info("segment duration is NaN!!!");
            }
        }
