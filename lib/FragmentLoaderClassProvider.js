    ...
    this.SRFragmentLoader = function (config) {
        ...
        function load(request) {
            ...
            const sendHttpRequestMetric = function(isSuccess, responseCode, requestDurationOffset = 0) {
                ...
                request.firstByteDate = requestDurationOffset ? (new Date(now - requestDurationOffset + computeEstimatedRTT(requestDurationOffset))) : request.firstByteDate || request.requestStartDate;
