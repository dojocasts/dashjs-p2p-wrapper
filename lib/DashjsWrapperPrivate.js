...
import MediaPlayerEvents from 'dashjs/build/es5/src/streaming/MediaPlayerEvents';
...
class DashjsWrapperPrivate {
    ...
    constructor (player, p2pConfig, liveDelay) {
        ...
        let MANIFEST_LOADED_23 = 'manifestloaded';
        let MANIFEST_LOADED_24 = 'manifestLoaded';
